 ...
 * datagrid detailview
 *
 * MODIFIED BY PHREESOFT
 * 1 - replace jq with jqy (used as a function variable that messes with Bizuno use of jq)
 * 2 - replace \$ with jq (so it works and load AFTER common.js)
 */
