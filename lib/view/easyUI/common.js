...
function drawBizunoChart(json) {
    ...
    switch (json.type) {
        ...
        case 'pie':
            ...
            options['slices']   = [{color: '#aac5e7'}, {color: '#000ccc'}, {color: '#0e2d5f'}, {color: '#000ddd'}, {color: '#eaf2ff'}, {color: '#000bbb'}, {color: '#b7d2ff'}];
...
function shippingEstimate() {
    ...
    var url = bizunoAjax+'&p=extShipping/ship/rateMain&resi='+resi+'&data='+content;
