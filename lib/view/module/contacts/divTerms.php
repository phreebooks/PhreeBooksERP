...
$output['body'] .= "	<td>".sprintf(lang('contacts_terms_discount'), html5('terms_disc', $viewData['fields']['terms_disc']), html5('terms_early', $viewData['fields']['terms_early'])).' '.sprintf(lang('contacts_terms_net'), html5('terms_net',$viewData['fields']['terms_net']))."</td>\n";
$output['body'] .= "  </tr>\n";
$temp = $viewData['fields']['terms_type'];
...
$output['body'] .= "	<td>".html5('terms_date', $viewData['fields']['terms_date'])."</td>\n";
$output['body'] .= "  </tr>\n";
$temp = $viewData['fields']['terms_type'];
...
$output['body'] .= "	<td>".html5('credit_limit', $viewData['fields']['credit_limit'])."</td>\n";
$output['body'] .= "  </tr>\n";
$output['body'] .= " </tbody>\n";
$output['body'] .= "</table>\n";

$callBack = !empty($viewData['fields']['call_back']) ? $viewData['fields']['call_back'] : 'terms';
$output['jsBody'][] = "
function termsSave() {
