...
define('DASHBOARD_MY_MESSAGES_VERSION','1.0');
...
class my_messages
{
    ...
    public function render()
    {
        $data = [
            ...
            $this->code.'_1'=>  ['label'=>lang('message'), 'attr'=>  ['required'=>'true', 'size'=>80],
              'classes'=> ['easyui-validatebox']],
            $this->code.'_button'=>  ['attr'=>  ['type'=>'button', 'value'=>lang('send')], 'styles'=>  ['cursor'=>'pointer'],
