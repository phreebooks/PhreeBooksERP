...
//                    'cashflow'=> ['order'=>80,'label'=>lang('cash_flow')),       'icon'=>'linechart','events'=>['onClick'=>"hrefClick('phreebooks/budget/cashFlow');"]],
        ...
        $this->phreeformProcessing = [
            ...
            'itmTaxAmt' => ['text'=>$this->lang['pb_line_item_tax'],   'group'=>$this->lang['title'],'module'=>$this->moduleID,'function'=>'processPhreeBooks'],
            ...
            'taxRate'   => ['text'=>lang('tax_rates_tax_rate')." (taxID)",'group'=>$this->lang['title'],'module'=>$this->moduleID,'function'=>'processPhreeBooks'],
