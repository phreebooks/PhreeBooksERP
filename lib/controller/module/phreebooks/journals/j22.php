 ...
 * @filesource /lib/controller/module/phreebooks/journals/j22.php
 */
...
/*******************************************************************************************************************/
    ...
    {
        $content = jrnlGetPaymentData($rID, $cID);
...
jq('#gl_acct_id').combogrid({'onChange': function(newVal, oldVal) { totalsGetBegBalance(); } });";
            ...
            $data['jsBody']['selVendor']= "jq('#contactSel').combogrid({width:120,panelWidth:500,delay:500,
