...
/*******************************************************************************************************************/
    ...
    public function getDataItem($rID=0) {
        ...
        $structure['sku']['defaults']['url']     = "'".BIZUNO_AJAX."&bizRt=inventory/main/managerRows&filter=assy&clr=1&bID='+jq('#store_id').val()";
    ...
    jq('#dgJournalItem').datagrid({ url:'".BIZUNO_AJAX."&bizRt=inventory/main/managerBOMList&rID='+data.id });
