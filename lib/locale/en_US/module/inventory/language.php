...
$lang = [
    ...
    // Settings
    'set_weight_uom'     => 'Default weight unit of measure.',
    'set_dim_uom'        => 'Default dimension unit of measure.',
	'set_tax_rate_id_c'  => 'Default sales tax rate to use for all inventory items for Sales.',
	'set_tax_rate_id_v'  => 'Default sales tax rate to use for all inventory items for Purchases.',
	'set_auto_add'       => 'Yes - Enable auto-add new items to inventory, default type will be Stock Item. No - SKUs must exist in inventory database to post to general ledger.',
	'set_auto_cost'      => 'If set, will set the latest cost in the inventory database when (PO) Purchase Orders are posted, (PR) Inventory items are received. This feature helps to keep your Unit Cost up to date with the latest costing.',
	'set_allow_neg_stock'=> 'Yes - Allow sales of items that are not in stock. No - require adequate stock to post to general journal.',
	'set_stock_usage'    => 'This feature will calculate the average and median item usage over the last 12 months and displays the results in a popup when the inventory item is edited.',
	'set_barcode_length' => 'Sets the length to expect for bar code scanners to auto-select inventory items. Set to zero (0) to disable bar code scanner auto-select input.',
	'set_inv_sales_' => 'Default GL Account for Sales/Income activities for inventory type: ',
	'set_inv_inv_'   => 'Default GL Account for Inventory/Wage activities for inventory type: ',
	'set_inv_cogs_'  => 'Default GL Account for Cost of Sales (COGS) for inventory type: ',
	'set_inv_meth_'  => 'Default Costing Method to use for inventory type: ',
