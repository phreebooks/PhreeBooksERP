 ...
 * @version    3.x Last Update: 2018-10-31
...
$lang = [
    ...
    // Settings
    'set_default_font' => '[Default: Helvetica] Sets the default font to use for standard reports. This setting will need to be changed to use UTF-8 character sets and other fonts using special characters.',
	'set_column_width' => 'Sets the default width of a column on reports. This setting will truncate long data strings to better format reports.',
	'set_margin' => 'Sets the default margin when creating new reports. ',
	'set_title1' => 'Sets the first report heading line. See substitution table for dynamically replacable fields. Default: %reportname%',
	'set_title2' => 'Sets the second report heading line. See substitution table for dynamically replacable fields. Default: Report Generated %date%',
	'set_paper_size' => 'Sets the default paper size to use when creating new reports and forms.',
	'set_orientation' => 'Sets the default paper orientation when creating new reports and forms.',
	'set_truncate_len' => 'Sets the maximum number of characters to display in a column on reports. This setting will truncate long data strings to better format reports.',
	// Labels
