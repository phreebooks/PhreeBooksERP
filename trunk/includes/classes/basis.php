...
class basis {
	...
	public function __construct() {
		...
		$this->mainmenu["customers"] 	= new \core\classes\menuItem (10, 	TEXT_CUSTOMERS);
		$this->mainmenu["vendors"]  	= new \core\classes\menuItem (20, 	TEXT_VENDORS);
		$this->mainmenu["inventory"]  	= new \core\classes\menuItem (30, 	TEXT_INVENTORY);
		$this->mainmenu["banking"] 		= new \core\classes\menuItem (40, 	TEXT_BANKING);
		$this->mainmenu["gl"] 			= new \core\classes\menuItem (50, 	TEXT_GENERAL_LEDGER);
		$this->mainmenu["employees"]	= new \core\classes\menuItem (60, 	TEXT_EMPLOYEES);
		$this->mainmenu["tools"] 		= new \core\classes\menuItem (70, 	TEXT_TOOLS);
		$this->mainmenu["quality"] 		= new \core\classes\menuItem (75, 	TEXT_QUALITY);
		$this->mainmenu["quality"]->required_module = array ('MODULE_CP_ACTION_STATUS' ,'MODULE_DOC_CTL_STATUS');
		$this->mainmenu["company"] 		= new \core\classes\menuItem (90, 	TEXT_COMPANY);
		$this->mainmenu["company"]->submenu ["configuration"]  	= new \core\classes\menuItem (10, 	TEXT_MODULE_ADMINISTRATION,	'', 	11);
	...
	public function set_database(){
		...
		try{
			...
			$this->DataBase = new \core\classes\PDO(DB_TYPE.":dbname={$_SESSION['user']->company};host=".DB_SERVER_HOST, DB_SERVER_USERNAME, DB_SERVER_PASSWORD);
	...
	public function startProcessingEvents() {
		...
		if (method_exists ( $this->observer, 'update' )) $this->observer->update($this);  
	}
