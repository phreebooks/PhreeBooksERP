...
//    	if ($basis->page != 'json' && $basis->page != 'ajax' && $basis->page == 'mobile') {
			...
			if      (file_exists("modules/phreedom/custom/language/{$_SESSION['user']->language->language_code}/jquery_i18n.js")) {
				$this->js_files[] = "modules/phreedom/custom/language/{$_SESSION['user']->language->language_code}/jquery_i18n.js";
			} elseif(file_exists("modules/phreedom/language/{$_SESSION['user']->language->language_code}/jquery_i18n.js")) {
				$this->js_files[] = "modules/phreedom/language/{$_SESSION['user']->language->language_code}/jquery_i18n.js";
			} else               $this->js_files[] = "modules/phreedom/language/en_us/jquery_i18n.js";
			//for easyui
			if      (file_exists("includes/easyui/custom/language/{$_SESSION['user']->language->language_code}/easyui_lang.js")) {
				$this->js_files[] = "includes/easyui/custom/language/{$_SESSION['user']->language->language_code}/easyui_lang.js";
			} elseif(file_exists("includes/easyui/language/{$_SESSION['user']->language->language_code}/easyui_lang.js")) {
				$this->js_files[] = "includes/easyui/language/{$_SESSION['user']->language->language_code}/easyui_lang.js";
