...
define('TEXT_THE_USERNAME_SUBMITTED_IS_NOT_VALID','O nome de usuário submetido não é válido.');
define('TEXT_THE_PASSWORD_SUBMITTED_IS_NOT_VALID','A senha submetida não é válida.');
define('TEXT_UNEXPECTED_ERROR','O servidor retornou um código de erro inesperado.');
