...
define('TEXT_UPDATE_EXCHANGE_RATE','Atualizar Taxa Câmbio');
...
define('TEXT_PLEASE_SELECT_THE_ADMIN_EXTRA_EMAIL_FORMAT','Por favor, selecione o formato de email extra para o Admin');
...
define('TEXT_DEFINES_THE_CHARACTER_SEQUENCE_USED_TO_SEPARATE_MAIL_HEADERS','Define a sequência de caracteres utilizada para separar headers de email.');
...
define('TEXT_MAXIMUM_NUMBER_OF_SEARCH_RESULTS_RETURNED_PER_PAGE','Número máximo de resultados de busca por página');
...
define('TEXT_GENERAL_JOURNAL_BEGINNING_BALANCES','Saldos Iniciais Diário Geral');
...
define('TEXT_PHREEBOOKS_SQL_ERROR_TRACE_INFORMATION','Informação Rastreio Erro SQL PhreeBooks');
