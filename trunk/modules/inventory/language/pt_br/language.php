...
define('TEXT_COLON_IS_NOT_ALLOWED_IN_THE_DESCRIPTION','Não é permitido dois pontos na descrição.');
define('TEXT_COMMA_IS_NOT_ALLOWED_IN_THE_DESCRIPTION','Não é permitido vírgula na descrição.');
...
define('TEXT_AVERAGE_USAGE_EXCLUDING_THIS_MONTH','Giro Médio (não inclui o mês corrente)');
define('TEXT_ARE_YOU_SURE_YOU_WANT_TO_DELETE_THIS_PRICE_SHEET','Tem certeza de que quer remover esta Tabela de Preço?');
define('TEXT_SPECIAL_PRICING','Preços Especiais');
define('TEXT_EXPIRATION_DATE','Data Expiração');
define('TEXT_LOAD_ITEM_PRICING','Carregar Preços Item');
...
define('TEXT_THE_PRICE_SHEET_NAME_CANNOT_BE_EMPTY','O nome da tabela de preço não pode estar vazio.');
...
define('TEXT_A_SKU_VALUE_IS_REQUIRED','Um valor de SKU é necessário.');
define('JS_SKU_BLANK','* O novo item precisa de um SKU ou código UPC\\n');
define('TEXT_NOT_ENOUGH_INFORMATION_WAS_PASSED_TO_RETRIEVE_THE_ITEM_DETAILS','Não foi passada informação suficiente para recuperar os detalhes do item');
...
define('TEXT_CANNOT_ADJUST_INVENTORY_WITH_A_ZERO_QUANTITY','Não é possível ajustar inventário com uma quantidade zerada!');
...
define('TEXT_USE_DEFAULT_PRICE_SHEET_SETTINGS','Usar Especificações Tabela Preços Padrão');
...
define('TEXT_REASON_FOR_TRANSFER','Motivo Transferência');
...
define('TEXT_FULL_PRICE_WITH_TAX','Preço Cheio com Imposto');
...
define('TEXT_RELATIVE_IMAGE_PATH','Caminho Relativo Imagem');
...
define('TEXT_MASTER_STOCK_ATTRIBUTES','Atributos Estoque Mestre');
...
define('TEXT_TO_STORE_ID','Para o Local ID');
...
define('TEXT_ROUND_VALUE','Valor Arredondamento');
...
define('TEXT_COMPONENTS_REQUIRED_FOR_THIS_ASSEMBLY','Componentes necessários para esta montagem');
...
define('TEXT_BULK_SKU_PRICING_ENTRY','Entrada de Preços SKU em lote');
...
define('TEXT_INVENTORY_ITEMS','Itens Inventário');
define('TEXT_ASSEMBLE_DISASSEMBLE_INVENTORY','Inventário Montagem/Desmontagem');
...
define('TEXT_DEFAULT_PURCHASE_TAX','Taxa Compra Padrão');
...
define('TEXT_OPEN_SALES_ORDERS','Ordens Venda Pendentes');
define('TEXT_OPEN_PURCHASE_ORDERS','Ordens Compra Pendentes');
define('TEXT_SKU_HISTORY','SKU Histórico');
define('INV_DATE_LAST_UPDATE','Última Atualização');
define('TEXT_LAST_ENTRY_DATE','Data Última Entrada');
define('INV_DATE_ACCOUNT_CREATION','Data Criação');
define('TEXT_CONTROLLED_STOCK','Estoque Controlado');
define('INV_XFER_SUCCESS','Transferência bem sucedida de %s peças do sku %s');
define('TEXT_NEXT_INCREMENT','Próximo Incremento');
define('TEXT_CONSTANT_CENTS','Centavos Contantes');
define('TEXT_NEXT_WHOLE','Próximo Dólar');
define('TEXT_INCREASE_BY_PERCENT','Aumento por Percentual');
define('TEXT_INCREASE_BY_AMOUNT','Aumento por Quantidade');
define('TEXT_DECREASE_BY_PERCENT','Desconto por Percentual');
define('TEXT_DECREASE_BY_AMOUNT','Desconto por Quantidade');
