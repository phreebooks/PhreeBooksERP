...
function clearForm() {
  ...
  document.getElementById('source_store_id').value     = <?php echo $_SESSION['user']->admin_prefs['def_store_id'] ? $_SESSION['user']->admin_prefs['def_store_id'] : 0; ?>;
  document.getElementById('dest_store_id').value       = <?php echo $_SESSION['user']->admin_prefs['def_store_id'] ? $_SESSION['user']->admin_prefs['def_store_id'] : 0; ?>;
