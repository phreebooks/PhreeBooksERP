...
?>
  <tr class="<?php echo $odd?'odd':'even'; ?>">
	...
	<td><?php echo html_input_field('min_'   . $j, $admin->currencies->precise($query_result->fields['minimum_stock_level']), 'size="11" style="text-align:right"'); ?></td>
	<td><?php echo html_input_field('reOrd_' . $j, $admin->currencies->precise($query_result->fields['reorder_quantity']), 'size="11" style="text-align:right"'); ?></td>
	<td><?php echo html_input_field('cost_'  . $j, $admin->currencies->precise($query_result->fields['item_cost']), 'size="11" style="text-align:right"'); ?></td>
	<td><?php echo html_input_field('sell_'  . $j, $admin->currencies->precise($query_result->fields['full_price']), 'size="11" style="text-align:right"'); ?></td>
