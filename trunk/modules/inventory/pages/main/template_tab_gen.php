...
<div title="<?php echo TEXT_GENERAL;?>" id="tab_general">
  ...
  <div class="easyui-window" id="inv_image" title="<?php echo $cInfo->sku; ?>" data-options="modal:true,closed:true" >
    <?php if (isset($cInfo->image_with_path) && $cInfo->image_with_path) {
    	echo html_image(DIR_WS_MY_FILES . $_SESSION['user']->company . '/inventory/images/' . $cInfo->image_with_path, '', 600) . chr(10);
    } else {
    	echo TEXT_NO_IMAGE;
    }
    ?>
  ...
  <table class="ui-widget" style="border-style:none;width:100%">
     ...
     <tr>
	  ...
	  <td rowspan="5" align="center">
		<?php if (isset($cInfo->image_with_path) && $cInfo->image_with_path) { // show image if it is defined
			echo html_image(DIR_WS_MY_FILES . $_SESSION['user']->company . '/inventory/images/' . $cInfo->image_with_path, $cInfo->image_with_path, '', '100', 'onclick="showImage()"');
		} else echo '&nbsp;'; ?>
	  </td>
	</tr>
	<tr>
    ...
    <table class="ui-widget" style="border-style:none;width:100%">
	 ...
	 <tbody class="ui-widget-content">
	<tr>
	  <td valign="top" align="right"><?php if(isset($cInfo->description_sales)) echo TEXT_SALES_DESCRIPTION; ?></td>
	...
	<tr>
	  <td align="right"><?php if(isset($cInfo->upc_code)) echo TEXT_UPC_CODE; ?></td>
	  ...
	  <td align="right"><?php if(isset($cInfo->image_with_path)) echo TEXT_SELECT_IMAGE; ?></td>
	  <td colspan="2"><?php if(isset($cInfo->image_with_path)) echo html_file_field('inventory_image'); ?></td>
	</tr>
	<tr>
	  <td align="right"><?php  if(!empty($cInfo->posible_cost_methodes)) echo TEXT_COST_METHOD; ?></td>
	  <td>
	...
	<tr>
	  <td align="right"><?php if(isset($cInfo->account_sales_income)) echo TEXT_SALES_INCOME_ACCOUNT; ?></td>
