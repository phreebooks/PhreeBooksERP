...
define('TEXT_SHIPPING_ADDRESS_BOOK_SETTINGS','Propriedades Livro Endereços de Entrega');
define('TEXT_RETURN_SERVICES_CHECKBOX','Serviços de retorno');
define('TEXT_DRY_ICE_CHECKBOX','Gelo seco');
define('TEXT_HAZARDOUS_MATERIAL_CHECKBOX','Material perigoso');
define('TEXT_SATURDAY_DELIVERY_CHECKBOX','Entrega Sábado');
define('TEXT_SATURDAY_PICKUP_CHECKBOX','Coleta Sábado');
define('TEXT_ENABLE_THE_COD_CHECKBOX_AND_OPTIONS','Habilitar caixa de COD e opções');
define('CD_10_32_DESC','Taxa adicional de manuseio');
define('TEXT_DELIVERY_CONFIRMATION_CHECKBOX','Confirmação de Entrega');
define('CD_10_20_DESC','Pewrmite que entregas gandes possam ser divididas para utilizar serviço de embalagem menor');
define('TEXT_SHIPMENT_INSURANCE_SELECTION_OPTION','Seleçãpo de opção de seguro de entrega.');
...
define('TEXT_DEFAULT_PACKAGE_TYPE_TO_USE_FOR_SHIPPING','Tipo padrão pacote entrega');
