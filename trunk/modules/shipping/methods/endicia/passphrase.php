...
$html .= '  </tr>' . "\n";
$html .= '  <tr>' . "\n";
$html .= '		<td>'. \core\classes\htmlElement::password('pass_phrase_current', TEXT_PASSPHRASE_NOW, null, true).'</td>' . "\n";
$html .= '  </tr>' . "\n";
$html .= '  <tr>' . "\n";
$html .= '		<td>'. \core\classes\htmlElement::password('pass_phrase_new', TEXT_PASSPHRASE, null, true).'</td>' . "\n";
$html .= '  </tr>' . "\n";
$html .= '  <tr>' . "\n";
$html .= '		<td>'. \core\classes\htmlElement::password('pass_phrase_confirm', TEXT_PASSPHRASE_DUP, null, true).'</td>' . "\n";
$html .= '  </tr>' . "\n";
$html .= ' </tbody>' . "\n";
$html .= '</table>' . "\n";
