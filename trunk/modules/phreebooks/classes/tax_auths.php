...
class tax_auths {
  ...
  function btn_delete($id = 0) {
	...
	$result = $admin->DataBase->query("select tax_auths from " . TABLE_JOURNAL_MAIN . "
  ...
  function build_main_html() {
    ...
    $result = $admin->DataBase->query("select tax_auth_id, description_short, description_long, account_id, tax_rate
