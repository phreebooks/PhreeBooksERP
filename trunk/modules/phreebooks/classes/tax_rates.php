...
class tax_rates {
  ...
  function build_main_html() {
    ...
    $result = $admin->DataBase->query("select tax_rate_id, description_short, description_long, rate_accounts, freight_taxable
...
// Get list of tax_auth for pull down
  function get_tax_auths() {
    global $admin;
    $tax_auth_values = $admin->DataBase->query("select tax_auth_id, description_short
