...
/*******************************************************************************************************************/
	function Post_account_sales_purchases() {
		global $admin;
		$admin->messageStack->debug("\n  Posting account sales and purchases nothing to post journal_16");
  	}

  	function unPost_account_sales_purchases() {
		global $admin;
		$admin->messageStack->debug("\n  unPosting account sales and purchases nothing to post journal_16");
  	}
...
/*******************************************************************************************************************/  
	...
	function post_ordr($action) {
		...
		// ************* POST journal entry *************
		if (!$this->validate_purchase_invoice_id()) throw new \core\classes\userException('invoice number is being used in a other post');
