...
class journal_03 extends \core\classes\journal {
	...
	public $description 		= TEXT_PURCHASE_QUOTES;
	...
	function validate_purchase_invoice_id() {
		...
		if ($this->purchase_invoice_id <> '') {	// entered a so/po/invoice value, check for dups
			...
			if ($result->fetch(\PDO::FETCH_NUM) == 0) throw new \core\classes\userException(sprintf(GL_ERROR_CANNOT_FIND_NEXT_ID, TABLE_CURRENT_STATUS));
