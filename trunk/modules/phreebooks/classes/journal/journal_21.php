...
class journal_21 extends orders {
    public $closed 				= '0';
...
/*******************************************************************************************************************/
// Journal START re-post Functions
/*******************************************************************************************************************/
	function check_for_re_post() {
		global $db, $messageStack;
		$messageStack->debug("\n  Checking for re-post records JOURNAL 06... ");
...
/*******************************************************************************************************************/
	function Post_account_sales_purchases() {
		global $messageStack;
		if (isset($this->bill_acct_id) && $this->bill_acct_id != '') return parent::Post_account_sales_purchases();
  	...
  	function unPost_account_sales_purchases() {
		global $messageStack;
		if (isset($this->bill_acct_id) && $this->bill_acct_id != '') return parent::unPost_account_sales_purchases();
