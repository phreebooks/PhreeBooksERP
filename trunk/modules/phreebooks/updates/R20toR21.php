...
if (!$admin->DataBase->field_exists(TABLE_DEPARTMENTS, 'description_short')) {
  ...
  $admin->DataBase->query("ALTER TABLE " . TABLE_DEPARTMENTS . " CHANGE primary_dept_id primary_dept_id INT(11) NOT NULL DEFAULT '0'");
  ...
  $result = $admin->DataBase->query("select id, params from " . TABLE_REPORT_FIELDS . " where entrytype = 'security'");
  while (!$result->EOF) {
...
// some other cleanup
$admin->DataBase->query("ALTER TABLE " . TABLE_SHIPPING_LOG . " CHANGE ship_date    ship_date    DATETIME    NOT NULL DEFAULT '0000-00-00 00:00:00'");
$admin->DataBase->query("ALTER TABLE " . TABLE_SHIPPING_LOG . " CHANGE deliver_date deliver_date DATETIME    NOT NULL DEFAULT '0000-00-00 00:00:00'");
$admin->DataBase->query("ALTER TABLE " . TABLE_SHIPPING_LOG . " CHANGE actual_date  actual_date  DATETIME    NOT NULL DEFAULT '0000-00-00 00:00:00'");
$admin->DataBase->query("ALTER TABLE " . TABLE_SHIPPING_LOG . " CHANGE ref_id       ref_id       VARCHAR(16) NOT NULL DEFAULT '0'");
...
$result = $admin->DataBase->query("select * from " . TABLE_RECONCILIATION);
while (!$result->EOF) {
