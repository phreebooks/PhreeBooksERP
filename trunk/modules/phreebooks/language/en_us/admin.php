...
define('TEXT_GENERAL_JOURNAL_SETTINGS','General Journal Settings');
...
define('TEXT_OTHER_CURRENT_ASSETS','Other Current Assets');
define('TEXT_FIXED_ASSETS','Fixed Assets');
define('TEXT_ACCUMULATED_DEPRECIATION','Accumulated Depreciation');
define('TEXT_OTHER_ASSETS','Other Assets');
define('TEXT_ACCOUNTS_PAYABLE','Accounts Payable');
define('TEXT_OTHER_CURRENT_LIABILITIES','Other Current Liabilities');
define('TEXT_LONG_TERM_LIABILITIES','Long Term Liabilities');
define('TEXT_INCOME','Income');
...
define('TEXT_CUSTOMER_RECEIVABLES','Customer/Receivables');
...
define('TEXT_BANKING_OR_INVENTORY_OR_OTHER','Banking/Inventory/Other');
define('TEXT_RE-POST_DATE_RANGE','Re-post Date Range');
...
define('TEXT_RE-POST_INVENTORY_OWED','Re-post Inventory Owed');
...
define('TEXT_VALIDATE_AND_REPAIR_GENERAL_LEDGER_ACCOUNT_BALANCES','Validate and Repair General Ledger Account Balances');
...
define('TEXT_FIX_CHART_BALANCE_ERRORS','Fix Chart Balance Errors');
...
define('TEXT_REPAIRED_GL_BALANCES','Repaired GL balances');
...
define('TEXT_NO_INVOICE_NUMBER_FOUND_ON_LINE_FLAGGED_AS_WAITING_FOR_PAYMENT_ARGS','No invoice number found on line %d. Flagged as waiting for payment!');
define('TEXT_EXITING_IMPORT_NO_INVOICE_NUMBER_FOUND_ON_LINE','Exiting import. No invoice number found on line ');
define('GL_BEG_BAL_ERROR_4','Exiting script. Bad date format found on line %d. Expecting format: ');
define('TEXT_SKIPPING_LINE._ZERO_TOTAL_AMOUNT_FOUND_ON_LINE','Skipping line. Zero total amount found on line ');
define('GL_BEG_BAL_ERROR_6','Invalid chart of account id found on line ');
define('TEXT_SKIPPING_INVENTORY_ITEM._ZERO_QUANTITY_FOUND_ON_LINE','Skipping inventory item. Zero quantity found on line ');
define('TEXT_FAILED_UPDATING_SKU_THE_PROCESS_WAS_TERMINATED_ARGS','Failed updating sku %s, the process was terminated.');
define('TEXT_FAILED_UPDATING_ACCOUNT_THE_PROCESS_WAS_TERMINATED_ARGS','Failed updating account %s, the process was terminated.');
define('TEXT_SUCCESSFULLY_POSTED_THE_CURRENT_ORDER_NUMBER_CHANGES','Successfully posted the current order number changes.');
...
define('TEXT_SETS_THE_START_DATE_FOR_ACCOUNT_AGING', 'Sets the start date for account aging.');
...
define('TEXT_TEXT_HEADING_USED_ON_REPORTS_TO_SHOW_AGING_FOR_DUE_DATE_NUMBER', 'Text heading used on reports to show aging for due date number 1.');
...
define('TEXT_DEFAULT_TERMS_FOR_PAYMENT', 'Default terms for payment');
...
/************************** (Chart of Accounts) ***********************************************/
define('TEXT_SELECT_A_STANDARD_CHART','Select a standard chart');
define('TEXT_REPLACE_CURRENT_CHART_OF_ACCOUNTS','Replace current chart of accounts');
define('TEXT_OR_CUSTOM_CHART_TO_IMPORT','or custom chart to import');
...
define('TEXT_THE_GL_ACCOUNT_ALREADY_EXISTS_THE_ACCOUNT_WILL_NOT_BE_ADDED_ARGS','The gl account: %s already exists!. The account will not be added.');
...
define('TEXT_THE_GL_ACCOUNT_TYPE_IS_REQUIRED','The GL Account Type is required!');
...
define('TEXT_TOTAL_TAX_PERCENT', 'Total Tax (percent)');
define('SETUP_TAX_EDIT_INTRO', 'Please make any necessary changes');
define('SETUP_INFO_TAX_AUTHORITIES', 'Tax Authorities');
define('TEXT_SELECT_A_TAX_AUTHORITY_TO_ADD', 'Select a tax authority to add');
define('TEXT_SELECT_A_TAX_AUTHORITY_TO_REMOVE', 'Select a tax authority to remove');
