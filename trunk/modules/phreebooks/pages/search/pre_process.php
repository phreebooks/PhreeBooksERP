...
$_SESSION['search_amount_from']  = $_REQUEST['search_amount_from'] ? $admin->currencies->clean_value($_REQUEST['search_amount_from']) : (isset($_SESSION['search_amount_from']) ? $_SESSION['search_amount_from']   : '');
$_SESSION['search_amount_to']    = $_REQUEST['search_amount_to']   ? $admin->currencies->clean_value($_REQUEST['search_amount_to'])   : (isset($_SESSION['search_amount_to'])   ? $_SESSION['search_amount_to']   : '');
