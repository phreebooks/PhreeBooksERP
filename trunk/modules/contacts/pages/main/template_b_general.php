...
?>
	<div title="<?php echo TEXT_GENERAL;?>" style="padding:10px">
		<fieldset>
	    	...
	    	<table>
	      		<tr> 
	      			<td><?php echo \core\classes\htmlElement::textbox("short_name",	TEXT_BRANCH_ID, 'size="21" maxlength="20"', $basis->cInfo->contact->short_name, $basis->cInfo->contact->auto_type == false);?></td>
