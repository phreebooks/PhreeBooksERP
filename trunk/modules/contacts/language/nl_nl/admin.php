...
define('TEXT_YES_ALSO_SELECT_PRIMARY_DEPARTMENT','Ja, Selecteer het primaire departement');
...
define('TEXT_DEPARTMENT_TYPES','Departement Types');
define('SETUP_INFO_DEPT_TYPES_NAME','Departement Type Naam');
define('TEXT_PLEASE_ENTER_THE_NEW_DEPARTMENT_TYPE','Voer een nieuw departement type in');
...
define('TEXT_PROJECT_PHASES','Project fasen ');
define('TEXT_COST_BREAKDOWN','Kosten Splitsen');
define('TEXT_USE_COST_BREAKDOWNS_FOR_THIS_PHASE','Gebruik maken van Kosten splitsen voor deze fase?');
