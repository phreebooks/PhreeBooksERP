...
define('TEXT_DUE_IN','Vencimento em ');
define('TEXT_PERCENT_SHORT','% ');
define('TEXT_PERCENT',' percentual ');
define('ACT_DISCOUNT','Desconto ');
define('TEXT_DUE_ON','Vencimento em');
define('TEXT_DUE_ON_SPECIFIED_DATE','Vencimento em data específica');
define('TEXT_DUE_END_OF_MONTH','Vencimento no final do mês');
define('ACT_SPECIAL_TERMS','Vencimento em número de dias');
define('TEXT_PREPAID','Pré-pago');
define('TEXT_CASH_ON_DELIVERY','Dinheiro na Entrega');
define('TEXT_CASH_ON_DELIVERY_SHORT','Contra Apresentação');
define('TEXT_USE_DEFAULT_TERMS','Usar Condição Padrão');
define('TEXT_DEFAULT','Padrão');
define('TEXT_TERMS_DUE','Condições (Vencimento)');
define('ACT_SPECIAL_TERMS','Condições Especiais');
define('TEXT_SECURITY_CODE','Código Segurança');
...
define('TEXT_CREDIT_CARD_NUMBER','Número Cartão de Crédito');
define('TEXT_CARDHOLDER_NAME','Nome Cartão de Crédito');
define('ACT_PAYMENT_MESSAGE','Entre a informação de pagamento a sere gravada no PhreeBooks.');
define('TEXT_INVOICE_NUMBER','Fatura Número');
define('ACT_PO_NUMBER','Compra Número');
define('ACT_SO_NUMBER','Venda Número');
define('TEXT_INVOICE_HISTORY_ARGS','Histórico Faturamento ( %s Resultados Mais Recentes)');
define('TEXT_PO_HISTORY_ARGS','Histórico Compras ( %s Resultados Mais Recentes)');
define('ACT_SO_HIST','Histórico Vendas ( %s Resultados Mais Recentes)');
define('TEXT_ORDER_HISTORY','Histórico Pedidos');
...
define('TEXT_CONTACT_INFORMATION','Informação Contato');
...
define('TEXT_HIRE_DATE','Data Admissão');
...
define('TEXT_LINK_TO_EMPLOYEE_ACCOUNT','Link Para Conta Funcionário');
define('TEXT_WEBSITE','Website');
define('TEXT_TWITTER_ID','ID Twitter');
define('TEXT_FACEBOOK_ID','ID Facebook');
...
define('TEXT_MIDDLE_NAME','Segundo Nome');
define('TEXT_FIRST_NAME','Nome');
define('TEXT_COUNTRY_ISO_CODE','Código ISO País');
define('TEXT_COUNTRY','País');
define('TEXT_POSTAL_CODE','CEP');
define('TEXT_STATE_PROVINCE','Estado');
define('TEXT_CITY_TOWN','Cidade');
define('TEXT_ADDRESS2','Endereço 2');
define('TEXT_ADDRESS1','Endereço 1');
define('TEXT_ATTENTION','Atenção');
define('TEXT_EMPLOYEE_NAME','Nome Funcionário');
define('TEXT_NEW_LEAD','Novo Assunto');
define('TEXT_NAME_OR_COMPANY','Nome/Empresa');
define('TEXT_FOLLOW_UP_CALL','Follow Up');
define('TEXT_RETURNED_CALL','Ligação Retornada');
define('TEXT_NEW_CALL','Nova Ligação');
define('TEXT_SALES_REP','Representante Vendas');
define('TEXT_TRANSFER_ADDRESS','Endereço Transferência');
...
define('TEXT_CONTACT_SEARCH','Pesquisa Contato');
define('TEXT_MONTHLY_SALES','Vendas Mensais');
define('TEXT_DAY_S',' dia(s). ');
...
define('TEXT_PAYMENT_REF','Referência Pagamento');
define('TEXT_OPEN_ORDERS','Ordens Compra em Aberto');
define('TEXT_OPEN_INVOICES','Faturas em Aberto');
