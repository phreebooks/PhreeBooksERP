...
define('TEXT_PLEASE_ENTER_THE_NEW_DEPARTMENT_TYPE','Por favor, entre o novo tipo de departamento');
define('SETUP_INFO_DEPT_TYPES_NAME','Nome Tipo Departamento');
define('TEXT_DEPARTMENT_TYPES','Tipos Departamento');
...
define('TEXT_YES_ALSO_SELECT_PRIMARY_DEPARTMENT','Sim, selecione também o departamento primário');
...
define('TEXT_PROJECT_PHASES','Fases Projeto');
define('TEXT_COST_BREAKDOWN','Detalhamento Custos');
define('TEXT_USE_COST_BREAKDOWNS_FOR_THIS_PHASE','Usar Detalhamento Custos para esta fase?');
