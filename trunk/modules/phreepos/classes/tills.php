  ...
  function build_form_html($action, $id = '') {
	 ...
	 */
  	...
  	function showDropDown(){
	    ...
	    if ($result->rowCount()== 0) throw new \core\classes\userException("Before continuing set a till for this store. This will contain default values to allow this page to work", E_USER_ERROR);// there should always be a till because of defaults values.
