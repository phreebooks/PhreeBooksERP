...
<?php if ($post_success && $_REQUEST['action'] == 'print') { ?>
  ClearForm();
  var printWin = window.open("index.php?module=phreeform&page=popup_gen&gID=<?php echo $order->popup_form_type; ?>&date=a&xfld=journal_main.id&xcr=EQUAL&xmin=<?php echo $oID; ?>","popup_gen","width=700px,height=550px,resizable=1,scrollbars=1,top=150px,left=200px");
  printWin.focus();
<?php } ?>
}
