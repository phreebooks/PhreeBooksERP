...
define('TEXT_FORM_PAGE_BREAK_FIELD','Form Page Break Field');
...
define('TEXT_SHOW_TOTALS_ONLY','Show Totals Only');
...
define('TEXT_REPORT_FILTER_DESCRIPTION','Report Filter Description');
define('TEXT_HEADER_INFORMATION_AND_FORMATTING','Header Information / Formatting');
...
define('TEXT_REPORT_TOTALS','Report Totals');
define('TEXT_TABLE_HEADING_PROPERTIES','Table Heading Properties');
define('PHREEFORM_DEFIMP','Reports/Forms Found in This Directory');
define('TEXT_SPECIAL_REPORT','Special Report (Programmers Only)');
...
define('TEXT_ARE_YOU_SURE_YOU_WANT_TO_DELETE_THIS_REPORT','Are you sure you want to delete this report?');
define('TEXT_NO_DIRECTORY_WAS_SELECTED_TO_DELETE','No directory was selected to delete!');
define('TEXT_THE_DIRECTORY_WAS_SUCESSFULLY_DELETED','The directory was sucessfully deleted!');
define('PHREEFORM_DIR_GROUP_DUP_ERROR','This group code has already been used in phreeform. Please select another Group Code!');
define('TEXT_THE_DIRECTORY_OF_REPORTS_WAS_IMPORTED_SUCCESSFULLY','The directory of reports was imported successfully!');
define('TEXT_THE_DIRECTORY_CANNOT_BE_MOVED_UNDER_ITSELF','The directory cannot be moved under itself.');
define('TEXT_THE_DIRECTORY_CANNOT_BE_DELETED_BECAUSE_IT_IS_NOT_EMPTY','The directory cannot be deleted because it is not empty!');
...
define('TEXT_WAS_SAVED_AND_COPIED_TO_REPORT',' was saved and copied to report: ');
...
define('TEXT_COPY_OF_DATA_TABLE','Copy of Data Table');
define('TEXT_DATA_TOTAL','Data Total');
define('TEXT_LETTER_TEMPLATE','Letter Template');
define('TEXT_LETTER_DATA','Letter Data');
define('TEXT_FIXED_TEXT_FIELD','Fixed Text Field');
define('TEXT_IMAGE_JPG_OR_PNG','Image - JPG or PNG');
...
define('TEXT_FORMATTED_DATE','Formatted Date');
define('TEXT_ROUND_2DECIMALS','Round (2 decimal)');
define('TEXT_CONVERT_DOLLARS','Convert Dollars');
define('PF_FRM_NULLDLR','Null if 0 - Dollars');
define('TEXT_CONVERT_EUROS','Convert Euros');
