...
function load_special_language($path, $class_name) {
  	if (file_exists($path . "language/{$_SESSION['language']->language_code}/classes/$class_name.php")) {
    	require_once ($path . "language/{$_SESSION['language']->language_code}/classes/$class_name.php");
