...
if ($acct_period == 'all') {
	...
	$periods       = $admin->DataBase->query("select * from " . TABLE_ACCOUNTING_PERIODS . " where period = $acct_period");
...
$customers = $admin->DataBase->query($query_raw, (MAX_DISPLAY_SEARCH_RESULTS * ($_REQUEST['list'] - 1)).", ".  MAX_DISPLAY_SEARCH_RESULTS);
