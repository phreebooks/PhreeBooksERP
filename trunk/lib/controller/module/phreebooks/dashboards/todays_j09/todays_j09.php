 ...
 * @filesource /lib/controller/module/phreebooks/dashboards/todays_j09/todays_j09.php
 * 
 */

namespace bizuno;

define('DASHBOARD_TODAYS_J09_VERSION','1.0');
...
class todays_j09
{
    ...
    {
		$this->security= getUserCache('security', 'j09_mgr', false, 0);
