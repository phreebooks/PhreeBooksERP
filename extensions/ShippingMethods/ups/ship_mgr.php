...
<table width="95%">
  <tr>
	...
	<td>
	 <table>
	  <tr>
		<th colspan="2"><?php echo SHIPPING_UPS_VIEW_REPORTS . \core\classes\DateTime::createFromFormat(DATE_FORMAT, $date); ?></th>
	  </tr>
	  <tr>
 ...
 <tbody class="ui-widget-content">
	...
	if ($result->fetch(\PDO::FETCH_NUM) > 0) {
		...
		while(!$result->EOF) {
			...
			echo '    <td align="right">' . ($result->fields['deliver_date'] <> '0000-00-00 00:00:00' ? \core\classes\DateTime::createFromFormat(DATE_FORMAT, $result->fields['deliver_date'], true) : '&nbsp;') . '</td>' . chr(10);
			echo '    <td align="right">' . ($result->fields['actual_date']  <> '0000-00-00 00:00:00' ? \core\classes\DateTime::createFromFormat(DATE_FORMAT, $result->fields['actual_date'], true)  : '&nbsp;') . '</td>' . chr(10);
