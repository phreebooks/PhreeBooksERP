...
define('TEXT_SHORT_DESCRIPTION','Description Short');
define('TEXT_DETAIL_DESCRIPTION','Detailed Description');
define('TEXT_TOOLS_AND_EQUIPMENT','Tools and Equipment');
...
define('TEXT_LAST_MANTAINENCE_DATE','Last Mantainence Date');
