...
define('TEXT_TOOLS_AND_EQUIPMENT','Máquinas e Equipamentos');
...
define('TEXT_IMAGE_RELATIVE_PATH','Imagem Caminho Relativo');
define('ASSETS_MSG_COPY_INTRO','Entre a nova ID Ativo para o novo ativo.');
define('TEXT_PURCHASE_CONDITION','Condição Compra');
define('TEXT_ASSET_RETIRE_DATE','Data Baixa Ativo');
define('TEXT_LAST_MANTAINENCE_DATE','Data Última Manutenção');
define('TEXT_ASSET_PURCHASE_DATE','Data Aquisição Ativo');
define('ASSETS_ENTRY_ASSETS_SERIALIZE','Marca/Modelo/Nº Série');
define('TEXT_GL_MAINTENANCE_ACCOUNT','CG Conta Manutenção');
define('TEXT_GL_DEPRECIATION_ACCOUNT','CG Conta Depreciação');
define('TEXT_GL_ASSET_ACCOUNT','CG Conta Ativo Patrimonial');
define('TEXT_ORIGINAL_COST','Custo Original');
define('TEXT_ASSET_TYPE','Tipo Ativo');
define('TEXT_ENTER_THE_ASSET_TYPE','Entre o Tipo de Ativo');
