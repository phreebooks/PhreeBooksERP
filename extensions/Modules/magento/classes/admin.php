...
class admin extends \core\classes\admin {
  ...
  function initialize() {
  	...
  	require_once(DIR_FS_MODULES . 'magento/classes/magento.php');
  ...
  function update() {
	...
	if ($result->RecordCount() == 0) $error = $messageStack->add('can not find tab_name Magento','error');
