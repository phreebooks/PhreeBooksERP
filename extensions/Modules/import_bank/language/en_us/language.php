...
define('TEXT_OUWER_BANK_ACCOUNT_IS_EMPTY','ouwer bank account is empty');
define('TEXT_THERE_ARE_TWO_OR_MORE_GL_ACCOUNTS_WITH_THE_DESCRIPTION','There are two or more gl accounts with the description');
define('TEXT_BIMP_ERMSG3','The other bank account is empty');
define('TEXT_THERE_ARE_TWO_OR_MORE_ACCOUNTS_WITH_THE_SAME_BANK_ACCOUNT','There are two or more accounts with the same bank account');
define('TEXT_THERE_IS_NO_GL_ACCOUNTS_WITH_THE_DESCRIPTION','There is no gl accounts with the description');
