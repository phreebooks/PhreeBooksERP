...
define('TEXT_FILE_NAME','Nome Arquivo');
define('TEXT_IMAGE_NOT_AVAILABLE','Imagem Não Disponível');
define('TEXT_LAST_UPDATE','Última Atualização');
define('TEXT_LAST_VIEW','Última Visualização');
define('TEXT_LOCK_DOCUMENT','Travar Documento');
...
define('TEXT_NO_DOCUMENTS_HAVE_BEEN_FOUND','Não forma encontrados documentos');
