...
define('TEXT_IMAGE_NOT_AVAILABLE','Image Not Available');
define('TEXT_LAST_UPDATE','Last Update');
define('TEXT_LAST_VIEW','Last View');
define('TEXT_LOCK_DOCUMENT','Lock Document');
...
define('TEXT_NO_DOCUMENTS_HAVE_BEEN_FOUND','No Documents Have Been Found.');
