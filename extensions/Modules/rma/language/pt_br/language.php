...
define('RMA_MESSAGE_ERROR','Houve um erro criando/atualizando a ARM.');
...
define('RMA_ERROR_CANNOT_DELETE','Houve um erro removendo a ARM.');
...
define('RMA_STATUS_1','ARM Criada/Aguardando Itens');
define('RMA_STATUS_2','Itens Recebidos');
define('RMA_STATUS_3','Recebendo Inspeção');
define('RMA_STATUS_4','A Disposição');
define('RMA_STATUS_5','Em Teste/Avaliação');
define('RMA_STATUS_6','Aguardando por Crédito');
define('RMA_STATUS_7','Fechado - Substituído');
define('RMA_STATUS_8','Fechado - Sem Garantia');
define('RMA_STATUS_9','Reclamação Dano');
define('RMA_STATUS_90','Fechado - Não Recebido');
define('RMA_STATUS_99','Fechado');
define('RMA_REASON_0','Selecione Motivo ARM ...');
define('RMA_REASON_1','Não é Necessário');
define('RMA_REASON_2','Item errado solicitado');
define('RMA_REASON_3','Não Condiz');
define('RMA_REASON_4','Defeituoso/Trocado');
define('RMA_REASON_5','Danificado no Transporte');
define('RMA_REASON_6','Recusado pelo Cliente');
define('RMA_REASON_7','Entrega Duplicada');
define('RMA_REASON_80','Conector Errado');
define('RMA_REASON_99','Outros (Especifique nas Anotações)');
define('RMA_ACTION_0','Selecione Ação ...');
define('RMA_ACTION_1','Retornar ao Estoque');
define('RMA_ACTION_2','Retornar ao Cliente');
define('RMA_ACTION_3','Testar & Substituir');
define('RMA_ACTION_4','Garantia Reposição');
define('RMA_ACTION_5','Descartar');
define('RMA_ACTION_6','Testar & Creditar');
