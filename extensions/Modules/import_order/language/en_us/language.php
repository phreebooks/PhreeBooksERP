...
define('IMPORT_ORDER_DIRECTIONS','After a file has been selected, press the Save icon to execute the script.<br />
		To view a template of the csv format and definitions, click the Download Template button.');
