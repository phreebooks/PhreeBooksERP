...
define('TEXT_LANGUAGE_CODE','Código ISO Idioma');
...
define('TEXT_MODULE_NAME_TO_IMPORT','Nome Módulo para Importar:');
define('TRANSLATOR_INSTALL_IMPORT','Nome Pasta install (se tiver sido movida após a instalação):');
define('TRANSLATOR_UPLOAD_DESC','Este formulário vai subir um arquivode idioma zip e importar todas as definições para a base de dados. Deve ser utilizado como auxílio na conversãode versões antigas para novas ou na modificação de traduções para outros idiomas.');
define('TRANSLATOR_ISO_CREATE','Idioma ISO para criar (formato xx_xx):');
define('TRANSLATOR_MODULE_CREATE','Módulo para atribuir tradução:');
define('TEXT_RELEASE_NUMBER_TO_CREATE','Número versão para criar:');
...
define('TEXT_PHREEDOM_LANGUAGE_TRANSLATION_FILE','Arquivo Tradução Idioma  Phreedom ');
