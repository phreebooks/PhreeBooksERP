...
define('SOAP_BAD_MANUFACTURER','De naam van de Fabrikant is niet gevonden in de Zencart manufacturers tabel. Gezocht naar Fabrikant %s voor artikel %s.');
...
define('SOAP_OPEN_FAILED','Error bij het openen van het afbeeldingsbestand: %s voor artikel %s');
