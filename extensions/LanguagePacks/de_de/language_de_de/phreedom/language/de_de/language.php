...
define('TEXT_PHREEBOOKS_ERP', 'Accounting');
...
define ('TEXT_ADD_OR_REMOVE_DASHBOARD_BOXES', 'Add / Remove Dashboard Boxes');
define ('TEXT_ADD_DASHBOARD_ITEMS_TO_THIS_PAGE', 'Add Dashboard Items zu diesem Menü');
define ('TEXT_USER_INFORMATION', 'Benutzer Information');
...
define ('TEXT_ACCOUNT_DESCRIPTION', 'Benutzerkonto Beschreibung');
...
define ('TEXT_COMPANY_NAME', 'Firmenname');
...
define ('TEXT_CSV', 'CSV');
define ('TEXT_CUSTOM_COLOR_RANGE_0-255', 'Custom Color (Range 0-255)');
...
define ('TEXT_DEFAULT_SALES_TAX', 'Default-Steuer ');
define ('TEXT_DEPARTMENT', 'Abteilung');
define ('TEXT_DESCRIPTION', 'Beschreibung');
define ('TEXT_DESCENDING_SHORT', 'sinkend');
...
define ('TEXT_MISCELLANEOUS', 'Verschiedenes');
define ('TEXT_MODULE', 'Modul');
define ('TEXT_MODULE_STATISTICS', 'Modul Statistik');
...
define ('TEXT_NEW', 'Neu');
define ('TEXT_NOT_EQUAL_TO', 'ungleich');
...
define ('TEXT_OUT_OF_BALANCE', 'Out of Balance');
...
define ('TEXT_SALES_TAX', 'Sales Tax');
...
define ('TEXT_STANDARD_COLOR', 'Standard Color');
...
define ('TEXT_TO', 'To');
define ('TEXT_TOGGLE_STATUS', 'Status wechseln');
...
define ('TEXT_THIS_WEEK', 'Diese Woche');
define ('TEXT_WEEK_TO_DATE', 'Week To Date ');
define ('TEXT_THIS_MONTH', 'This Month');
define ('TEXT_MONTH_TO_DATE', 'Monat To Date ');
...
define ('TEXT_SUN', 'S');
define ('TEXT_MON', 'M');
define ('TEXT_TUESDAY_LETTER', 'T');
define ('TEXT_WED', 'W');
define ('TEXT_THURSDAY_LETTER', 'T');
define ('TEXT_FRI', 'F');
define ('TEXT_SAT', 'S');
...
define ('TEXT_A_REQUIRED_FIELD_HAS_BEEN_LEFT_BLANK_FIELD', 'Ein erforderliches Feld ausgefüllt worden Feld:.');
...
define ('TEXT_YOU_DO_NOT_HAVE_PERMISSION_TO_VIEW_THIS_SEARCH_RESULT', 'Sie haben keine Berechtigung, um diese Suche Ergebnis zu sehen.');
...
define ('TEXT_BACKUP_COMPRESSION_FAILED', 'Backup-Komprimierung ist fehlgeschlagen');
define ('TEXT_ENCRYPTION_KEY_IS_SET', 'Encryption Key ist gesetzt');
define ('GEN_MSG_COPY_INTRO', 'Bitte geben Sie den neuen Benutzernamen ein.');
define ('TEXT_THE_USERNAME_IS_ALREADY_IN_USE_PLEASE_SELECT_A_DIFFERENT_NAME', 'Der Benutzername ist bereits im Einsatz Bitte wählen Sie einen anderen Namen..');
...
define ('TEXT_THE_EMAIL_MESSAGE_WAS_NOT_SENT', 'Die E-Mail wurde nicht gesendet.');
...
define ('TEXT_THE_PASSWORD_CONFIRMATION_MUST_MATCH_YOUR_NEW_PASSWORD', 'Die Passwort-Bestätigung muss Ihr neues Passwort übereinstimmen.');
define ('ENTRY_PASSWORD_NEW_ERROR', 'Ihr neues Passwort muss mindestens %s Zeichen');
...
define ('TEXT_YOU_ENTERED_THE_WRONG_EMAIL_ADDRESS', 'Sie haben die falsche E-Mail-Adresse ein.');
...
define ('TEXT_YOU_ENTERED_THE_WRONG_USERNAME_OR_PASSWORD', 'Sie haben den falschen Benutzernamen oder Kennwort.');
...
// Tooltip Nachrichten
define ('TEXT_JUMP_TO_FIRST_PAGE', 'Zur ersten Seite');
define ('TEXT_PREVIOUS_PAGE', 'zurück');
define ('TEXT_NEXT_PAGE', 'Nächste Seite');
define ('TEXT_JUMP_TO_LAST_PAGE', 'Zur letzten Seite');
...
define('TEXT_COMPANY_DATABASE_BACKUP','Company Database Backup');
define('GEN_LOG_PERIOD_CHANGE','Accounting Period - Change');
define('TEXT_MODULE_ARGS','Module %s: ');
