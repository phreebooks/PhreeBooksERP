...
define ('TEXT_DEFAULT_AP_ACCOUNT', 'Default Verbindlichkeiten Konto');
...
define ('TEXT_DOWNLOAD_DEBUG', 'Download Debug-Informationen');
define ('TEXT_CONFIG_SAVED', 'haben Configuration Werte gespeichert.');
