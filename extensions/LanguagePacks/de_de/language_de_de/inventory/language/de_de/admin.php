...
define ('TEXT_VALIDATE_INVENTORY_QUANTITY_ON_ORDER_VALUES', 'Validate Bestandsmenge auf Auftrag Werte');
...
define ('TEXT_BEGIN_TEST_AND_REPAIR', 'Begin Testen und Reparieren');
...
define ('TEXT_VALIDATE_INVENTORY_DISPLAYED_STOCK', 'Validate Inventar angezeigt Stock');
...
define ('TEXT_YOUR_INVENTORY_BALANCES_ARE_OK', 'Ihr Inventar Guthaben sind in Ordnung.');
