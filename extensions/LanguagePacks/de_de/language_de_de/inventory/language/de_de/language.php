...
define ('TEXT_SERIALIZED_ITEM', 'Serialisierte Artikel');
define ('TEXT_MASTER_STOCK_ITEM', 'Master Stock Item');
define ('TEXT_ITEM_ASSEMBLY', 'Artikel-Versammlung');
define ('TEXT_SERIALIZED_ASSEMBLY', 'Serialisierte Versammlung');
define ('TEXT_NON-STOCK_ITEM', 'Keine Lagerware');
define ('INV_TYPES_LB', 'Arbeit');
define ('INV_TYPES_SV', 'Service');
define ('TEXT_FLAT_RATE_SERVICE', 'Flat Rate Service');
define ('TEXT_CHARGE_ITEM', 'Charge Artikel');
define ('INV_TYPES_AI', 'Activity Artikel');
define ('INV_TYPES_DS', 'Beschreibung');
define ('TEXT_ITEM_ASSEMBLY_PART', 'Artikel-Versammlung Teil');
define ('TEXT_MASTER_STOCK_SUB_ITEM', 'Master Stock Unterpunkt');

define ('TEXT_FIFO', 'FIFO');
define ('TEXT_LIFO', 'LIFO');
define ('TEXT_AVERAGE', 'Durchschnittliche');
...
define ('TEXT_DECREASE_BY_AMOUNT', 'Abnahme von Anzahl');
define ('TEXT_DECREASE_BY_PERCENT', 'Abnahme in Prozent');
define ('TEXT_INCREASE_BY_AMOUNT', 'Erhöhung von Anzahl');
define ('TEXT_INCREASE_BY_PERCENT', 'Erhöhung in Prozent');
define ('TEXT_NEXT_WHOLE', 'Next-Dollar');
define ('TEXT_DEFINED_CONSTANT_CENTS', 'Constant Cents');
define ('TEXT_NEXT_INCREMENT', 'Weiter Inkrement');
define ('INV_XFER_SUCCESS', 'erfolgreich übertragen %s Stücke sku %s');
define ('TEXT_CONTROLLED_STOCK', 'Kontrollierte Lieferung');
...
define ('TEXT_LAST_ENTRY_DATE', 'Letzter Eintrag Datum');
define ('TEXT_SKU_HISTORY', 'SKU Geschichte');
define ('TEXT_OPEN_PURCHASE_ORDERS', 'offenen Bestellungen');
define ('TEXT_OPEN_SALES_ORDERS', 'Öffnen Kundenauftrag');
define ('TEXT_PURCHASES_BY_MONTH', 'Käufe Nach Monat');
...
define ('TEXT_PO_DATE', 'Bestelldatum');
define ('TEXT_SO_DATE', 'SO Datum');
define ('TEXT_RECEIVE_DATE', 'Receive Datum');
define ('INV_SO_SHIP_DATE', 'Ship Date');
define ('TEXT_PURCHASE_COST', 'Kaufpreis');
define ('TEXT_SALES_INCOME', 'Umsatz Ergebnis');
define ('TEXT_THIS_MONTH', 'This Month');
define ('TEXT_DEFAULT_PURCHASE_TAX', 'Default Umsatzsteuer-');
define ('TEXT_LAST_MONTH', 'Letzter Monat');
define ('TEXT_3_MONTHS', '3 Monate ');
define ('TEXT_6_MONTHS', '6 Monate ');
define ('TEXT_12_MONTHS',' 12 Monate ');
...
define ('TEXT_SALES_DESCRIPTION', 'Sales Beschreibung');
define ('TEXT_ASSEMBLE_DISASSEMBLE_INVENTORY', 'Montage / Demontage Inventory');
...
define ('TEXT_INVENTORY_ADJUSTMENTS', 'Inventory Anpassungen');
define ('TEXT_ADJUSTMENT_ACCOUNT', 'Einstellung Konto');
define ('INV_POPUP_PRICES_WINDOW_TITLE', 'Artikelnummer Preis-Liste');
define ('TEXT_BULK_SKU_PRICING_ENTRY', 'Bulk SKU Pricing Eintrag');
define ('TEXT_TRANSFER_INVENTORY_BETWEEN_STORES', 'Transfer Inventory Zwischen Werkzeug');

define ('TEXT_QUANTITY_ON_HAND_SHORT', 'Anzahl an Hand');
define ('TEXT_QUANTITY_ON_HAND', 'Menge an Hand');
define ('INV_HEADING_SERIAL_NUMBER', 'Serial Number');
define ('INV_HEADING_QTY_TO_ASSY', 'Anzahl zu montieren');
define ('TEXT_QUANTITY_ON_ORDER_SHORT', 'Anz auf Bestellung');
define ('TEXT_QUANTITY_IN_STOCK_SHORT', 'Menge auf Lager');
define ('TEXT_QTY_THIS_STORE', 'Anzahl dieser Branch');
define ('INV_HEADING_QTY_ON_SO', 'Anzahl an Sales Order');
define ('TEXT_QUANTITY_ON_SALES_ORDER', 'Menge auf Sales Order');
define ('TEXT_PREFERRED_VENDOR', 'Preferred Vendor ');
define ('TEXT_LEAD_TIME_DAYS', 'Lead Zeit (Tage)');
define ('TEXT_QUANTITY_ON_PURCHASE_ORDER', 'Menge auf Bestellung');
define ('TEXT_COMPONENTS_REQUIRED_FOR_THIS_ASSEMBLY', 'Komponenten, die für diese Versammlung');
define ('TEXT_QTY_REMAINING', 'Anz Verbleibende');
define ('INV_TEXT_UNIT_COST', 'Unit Cost ');
define ('TEXT_CURRENT_VALUE', 'Current Value');
define ('INV_TEXT_NEW_VALUE', 'New Value');

define ('TEXT_ADJUSTMENT_QUANTITY_SHORT', 'Einstellung Menge');
define ('TEXT_REASON_FOR_ADJUSTMENT', 'Grund für die Einstellung');
define ('TEXT_ADJUSTMENT_VALUE_SHORT', 'Adj-Wert.');
define ('TEXT_ROUNDING', 'Rundung');
define ('TEXT_ROUND_VALUE', 'Rnd-Wert.');
...
define ('TEXT_TRANSFER_FROM_STORE_ID', 'Transfer vom Store ID');
define ('TEXT_TO_STORE_ID', 'Um Store ID');
define ('TEXT_TRANSFER_QUANTITY', 'Transfer Menge');
...
define ('TEXT_MASTER_STOCK_ATTRIBUTES', 'Master Stock Attribute');
define ('TEXT_ATTRIBUTE_1', 'Attribut 1');
define ('TEXT_ATTRIBUTE_2', 'Attribut 2');
...
define ('TEXT_ITEM_WEIGHT', 'Artikelgewicht');
define ('TEXT_MINIMUM_STOCK_LEVEL', 'Mindestbestand');
define ('TEXT_REORDER_QUANTITY', 'Reorder Menge');
define ('INV_ENTRY_INVENTORY_COST_METHOD', 'Cost Method');
define ('TEXT_SERIALIZE_ITEM', 'Serialize Artikel');
...
define ('TEXT_USE_DEFAULT_PRICE_SHEET_SETTINGS', 'Use Default Preisblatt Einstellungen');
...
define ('TEXT_THE_PRICE_SHEET_NAME_CANNOT_BE_EMPTY', 'Der Preis Blattname darf nicht leer sein.');

// Audit-Log-Einträge
define ('INV_LOG_ADJ', 'Inventory Einstellung -');
define ('TEXT_INVENTORY_ASSEMBLY', 'Inventory Versammlung');
...
define ('TEXT_PRICE_SHEET_NAME', 'Preis Blattname');
