...
define ('TEXT_NEW_TRANSLATION', 'Neue Übersetzung');
define ('TEXT_IMPORT_TRANSLATION', 'Import Übersetzung');
define ('TEXT_EXPORT_TRANSLATION', 'Export Übersetzung');
...
define ('TEXT_TRANSLATION', 'Übersetzung');
define ('TEXT_TRANSLATIONS', 'Übersetzungen');
